...
async def on_msg(u: Update, c: ContextTypes.DEFAULT_TYPE):
    ...
    reply = ask(d,
        ...
        "Ответь как живой тренер — коротко (2-4 предложения), с характером. "
        "Максимум ОДИН вопрос если нужен. Верь пользователю — не переспрашивай одно и то же. "
        "СТРОГО ЗАПРЕЩЕНО: JSON любого вида, тренировки в ответе, фраза 'пришлю в 20:00'. "
        "Только текст."
    )
    save(d)
